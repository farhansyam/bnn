                             ...
                             <i class="fa fa-thumb-tack"></i>
                              ...
                              <ul class="sidebar-submenu">
                               @if ($menu->ChildMenu->count() > 0)
                                 ...
                                 @if ($childMenu->type == 1)
                                <li>
                                 <a class="submenu-title" href="javascript:void(0)" data-bs-original-title="" title="">{{$childMenu->name}}<span class="sub-arrow"><i class="fa fa-angle-right"></i></span><div class="according-menu"><i class="fa fa-angle-down"></i></div></a>
                                 <ul class="nav-sub-childmenu submenu-content">
                                    <li><a href=""><i data-feather="image"></i>Gallery</a></li>
                                </ul>
                                </li>
                                 @elseif($childMenu->type == 2)
                                    <li><a href="dashboard-02.html"><i data-feather="play-circle"></i>Video</a></li>
                                 @else
                                    <li><a href="{{route('galleri.index',$childMenu->id)}}"><i data-feather="image"></i>{{$childMenu->name}}</a></li>
                                 @endif
                                 @endforeach
                               @else  
                               @endif
